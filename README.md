...
1. Compute Resources
    1) Virtual Machines (VMs): Provision and manage Windows/Linux virtual machines.
        Example: azurerm_linux_virtual_machine, azurerm_windows_virtual_machine
    2) Virtual Machine Scale Sets (VMSS): Automate scaling of VM instances.
        Example: azurerm_virtual_machine_scale_set
    3) Azure Kubernetes Service (AKS): Set up and manage Kubernetes clusters for containerized applications.
        Example: azurerm_kubernetes_cluster
    4) Azure Functions: Deploy serverless functions for event-driven applications.
        Example: azurerm_function_app
    5) App Service Plan: Configure the infrastructure for hosting web applications or APIs.
        Example: azurerm_app_service_plan
    6) App Service: Deploy and manage web apps, APIs, or mobile backends.
